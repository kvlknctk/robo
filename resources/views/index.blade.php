...
@section('content')
            ...
            <div class="item imgbg" style="background-image:url(img/img-slide-1.jpg)">
                ...
                <div class="overlay-main v-align text-center">
                    <div class="col-md-10 col-xs-11">
                        ...
                        <h1>BLACK CONSTRUCTION</h1>
                        <h3 class="main-text color">We Build Your Dream</h3>
                        <p>Lorem ipsum dolor sit amet,tempus etex Vestibulum pellentesque et dolor sit amet. Pellentesque eu enim nec nibh convallis suscipit. Morbi interdum dignissim metus dignissim gravida.</p>
            ...
            <div class="item imgbg" style="background-image:url(img/img-slide-2.jpg)">
                ...
                <div class="overlay-main v-align text-center">
                    <div class="col-md-10 col-xs-11">
                        ...
                        <h1>BLACK CONSTRUCTION</h1>
                        <h3 class="main-text color">We Are Passionate</h3>
                        <p>Lorem ipsum dolor sit amet,tempus etex Vestibulum pellentesque et dolor sit amet. Pellentesque eu enim nec nibh convallis suscipit. Morbi interdum dignissim metus dignissim gravida.</p>
            ...
            <div class="item imgbg" style="background-image:url(img/img-slide-3.jpg)">
                <div class="overlay-main v-align text-center">
                    <div class="col-md-10 col-xs-11">
                        ...
                        <h1>BLACK CONSTRUCTION</h1>
                        <h3 class="main-text color">We Are Capable</h3>
                        <p>Lorem ipsum dolor sit amet,tempus etex Vestibulum pellentesque et dolor sit amet. Pellentesque eu enim nec nibh convallis suscipit. Morbi interdum dignissim metus dignissim gravida.</p>
    ...
    <section id="step-page" class="step-page">
        <div class="container">
            <div class="row">
                ...
                <div class="step-mains onStep" data-animation="fadeInUp" data-time="300">
                ...
                <div id="step-text" class="col-md-12 onStep" data-animation="fadeInUp" data-time="600">
    ...
    <!-- section -->
    <section class="yellowpage">
        <div class="onStep" data-animation="animbouncefall" data-time="300">
            <div class="container">
                <div class="row">
    ...
    <section id="brand" class="brand-page">
        <div class="container">
            <div class="row">
    ...
    <!-- section contact -->
    <section class="whitepage no-top no-bottom" id="contactus">
