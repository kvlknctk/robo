<?php
    ...
    */
    ...
    Route::get('/calismalar/{slug}', ['as' => 'calismalar_cat', 'uses' => 'HomeCTRL@calismalar_cat']);
    Route::get('/calismalar/{slug}/{work}', ['as' => 'calismalar_detail', 'uses' => 'HomeCTRL@calismalar_detail']);
